...
Route::prefix($app_name)
    ...
    ->group(function () {
        ...
        Route::get('/tech-activity', [TechActivityController::class, 'index'])->name('tech.activity');

        Route::get('/tech-activity-deleted', [TechActivityController::class, 'deletedActivity'])->name('tech.activity.deleted');
        ...
        Route::get('/doneActivity', [OngoingActivityController::class, 'doneActivities'])->name('tech.doneActivities');

        // ADD route
        Route::post('/ongoing/add', [OngoingActivityController::class, 'addActivity'])->name('ongoing.add');

        // UPDATE route (new)
        Route::put('/ongoing/update/{id}', [OngoingActivityController::class, 'updateActivity'])->name('ongoing.update');

        Route::get('/activity', [OngoingController::class, 'index'])->name('activity');

        Route::get('/forApproval', [OngoingActivityController::class, 'forApproval'])->name('tech.forApproval');

        Route::put('/forApproval/approve/{id}', [OngoingActivityController::class, 'forApprovalActivity'])->name('ongoing.approve');

        Route::put('/forApproval/reject/{id}', [OngoingActivityController::class, 'reject']);
