...
`}</style>
      ...
      <div className="min-h-screen animated-bg flex justify-center items-center px-4 rounded-md border border-4 border-blue-700">
        <div className="bg-white/90 backdrop-blur-xl w-full max-w-3xl rounded-2xl shadow-2xl p-10 border border-4 border-[#3c8dbc]">
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-4xl font-extrabold text-gray-700 uppercase">System Maintenance</h1>
            <p className="text-gray-600 mt-2">
                Sorry for the inconvenience! This module is still under development — feel free to play a mini-game while waiting.
            </p>
